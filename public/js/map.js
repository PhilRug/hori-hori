...
function initMap({ latitude, longitude }) {
  ...
  form.innerHTML = `
    ...
    <option disabled selected value="">Select an invasive plant species</option>
      ...
      <option value="Purple Loosestrife" data-image="https://www.gardeningknowhow.com/wp-content/uploads/2023/01/purple-loostrife-400x300.jpg">Purple Loosestrife</option>
    ...
    <textarea rows="4" cols="10" id="description" style="resize: none;" name="description" required></textarea>
    <br>
    <img id="plantImage" style="display: none; width: 7rem; height: 8rem;" src="">
    <br>
